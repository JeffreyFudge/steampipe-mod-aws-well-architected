...
benchmark "well_architected_framework_sec02" {
  title       = "Security: How do you manage identities for people and machines?"
...
benchmark "well_architected_framework_sec02_bp01" {
  title       = "Security: Use strong sign-in mechanisms"
...
benchmark "well_architected_framework_sec02_bp02" {
  title       = "Security: Use temporary credentials"
...
benchmark "well_architected_framework_sec02_bp03" {
  title       = "Security: Store and use secrets securely"
...
benchmark "well_architected_framework_sec02_bp05" {
  title       = "Security: Audit and rotate credentials periodically"
