...
benchmark "well_architected_framework_sec09" {
  title       = "Security: How do you protect your data in transit?"
...
benchmark "well_architected_framework_sec09_bp01" {
  title       = "Security: Implement secure key and certificate management"
...
benchmark "well_architected_framework_sec09_bp02" {
  title       = "Security: Enforce encryption in transit"
...
benchmark "well_architected_framework_sec09_bp03" {
  title       = "Security: Automate detection of unintended data access"
...
benchmark "well_architected_framework_sec09_bp04" {
  title       = "Security: Authenticate network communications"
