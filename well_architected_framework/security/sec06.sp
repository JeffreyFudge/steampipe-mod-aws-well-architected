...
benchmark "well_architected_framework_sec06" {
  title       = "Security: How do you protect your compute resources?"
  ...
  children = [
    ...
    benchmark.well_architected_framework_sec06_bp06
  ]
...
benchmark "well_architected_framework_sec06_bp01" {
  title       = "Security: Perform vulnerability management"
...
benchmark "well_architected_framework_sec06_bp02" {
  title       = "Security: Reduce attack surface"
...
benchmark "well_architected_framework_sec06_bp03" {
  title       = "Security: Implement managed services"
...
benchmark "well_architected_framework_sec06_bp04" {
  title       = "Security: Automate compute protection"
...
benchmark "well_architected_framework_sec06_bp05" {
  title       = "Security: Enable people to perform actions at a distance"
...
benchmark "well_architected_framework_sec06_bp06" {
  title       = "Security: Validate software integrity"
