...
benchmark "well_architected_framework_sec03" {
  title       = "Security: How do you manage permissions for people and machines?"
...
benchmark "well_architected_framework_sec03_bp01" {
  title       = "Security: Define access requirements"
...
benchmark "well_architected_framework_sec03_bp02" {
  title       = "Security: Grant least privilege access"
...
benchmark "well_architected_framework_sec03_bp03" {
  title       = "Security: Establish emergency access process"
...
benchmark "well_architected_framework_sec03_bp04" {
  title       = "Security: Reduce permissions continuously"
...
benchmark "well_architected_framework_sec03_bp05" {
  title       = "Security: Define permission guardrails for your organization"
...
benchmark "well_architected_framework_sec03_bp06" {
  title       = "Security: Manage access based on lifecycle"
...
benchmark "well_architected_framework_sec03_bp07" {
  title       = "Security: Analyze public and cross-account access"
...
benchmark "well_architected_framework_sec03_bp08" {
  title       = "Security: Share resources securely within your organization"
