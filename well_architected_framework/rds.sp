...
control "rds_db_instance_encryption_at_rest_enabled" {
  ...
  description = "To help protect data at rest, ensure that encryption is enabled for your AWS Relational Database Service (AWS RDS) instances.  All positive findings are hidden to reduce report size."
...
# Modified by jfudge to eliminate positive findings (reduce report size) - added where clause
