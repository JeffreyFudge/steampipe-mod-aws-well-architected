...
locals {
  ebs_common_tags = merge(local.well_architected_framework_cost_common_tags, {
    service = "AWS/EBS"
  })
}

benchmark "ebs" {
  title         = "Cost Optimization: EBS"
  description   = "Identify unused and under-utilized EBS volumes."
  children = [
