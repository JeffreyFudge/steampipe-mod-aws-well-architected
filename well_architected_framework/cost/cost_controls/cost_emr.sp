locals {
  emr_common_tags = merge(local.well_architected_framework_cost_common_tags, {
    service = "AWS/EMR"
  })
}

benchmark "emr" {
  title         = "Cost Optimization: EMR"
  description   = "Identify and migrate EMR clusters of previous generation instances and idle clusters."
