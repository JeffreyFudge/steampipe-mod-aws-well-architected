...
locals {
  elasticache_common_tags = merge(local.well_architected_framework_cost_common_tags, {
    service = "AWS/ElastiCache"
  })
}

benchmark "elasticache" {
  title         = "Cost Optimization: ElastiCache"
  description   = "Ensure long running ElastiCache clusters are associated with reserved nodes."
  children = [
