...
locals {
  ecs_common_tags = merge(local.well_architected_framework_cost_common_tags, {
    service = "AWS/ECS"
  })
}

benchmark "ecs" {
  title         = "Cost Optimization: ECS"
  description   = "Review under-utilized ECS clusters and ECS service without autoscaling configuration."
