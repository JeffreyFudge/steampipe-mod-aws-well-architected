...
locals {
  rds_common_tags = merge(local.well_architected_framework_cost_common_tags, {
    service = "AWS/RDS"
  })
}

benchmark "rds" {
  title         = "Cost Optimization: RDS"
  description   = "Eliminate unused and under-utilized RDS instances."
  children = [
