locals {
  cloudtrail_common_tags = merge(local.well_architected_framework_cost_common_tags, {
    service = "AWS/CloudTrail"
  })
}

benchmark "cloudtrail" {
  title         = "Cost Optimization: CloudTrail"
  description   = "Multiple active CloudTrail Trails can add significant costs. Review and eliminate any extra trails."
...
control "multiple_global_trails" {
  title       = "Are there redundant global cloud trails?"
