...
locals {
  redshift_common_tags = merge(local.well_architected_framework_cost_common_tags, {
    service = "AWS/Redshift"
  })
}

benchmark "redshift" {
  title         = "Cost Optimization: Redshift"
  description   = "Verify long running Redshift clusters are associated with reserved nodes."
