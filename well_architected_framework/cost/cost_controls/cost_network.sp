locals {
  vpc_common_tags = merge(local.well_architected_framework_cost_common_tags, {
    service = "AWS/VPC"
  })
}

benchmark "network" {
  title         = "Cost Optimization: Networking"
  description   = "Remove unused or unnecessary network resources."
