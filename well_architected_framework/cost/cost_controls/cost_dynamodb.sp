...
locals {
  dynamodb_common_tags = merge(local.well_architected_framework_cost_common_tags, {
    service = "AWS/DynamoDB"
  })
}

benchmark "dynamodb" {
  title         = "Cost Optimization: DynamoDB"
  description   = "Delete DynamoDB tables with stale data."
