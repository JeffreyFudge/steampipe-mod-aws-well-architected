locals {
  route53_common_tags = merge(local.well_architected_framework_cost_common_tags, {
    service = "AWS/Route 53"
  })
}

benchmark "route53" {
  title         = "Cost Optimization: Route 53"
  description   = "Monitor the actual usage of the Route 53 service."
