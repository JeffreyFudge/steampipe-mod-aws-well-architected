...
benchmark "well_architected_framework_ops05" {
  title       = "Operational Excellence: How do you reduce defects, ease remediation, and improve flow into production?"
...
benchmark "well_architected_framework_ops05_bp03" {
  title       = "Operational Excellence: Use configuration management systems"
...
benchmark "well_architected_framework_ops05_bp05" {
  title       = "Operational Excellence: Perform patch management"
