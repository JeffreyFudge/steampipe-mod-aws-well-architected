...
benchmark "well_architected_framework_rel06" {
  title       = "Reliability: How do you monitor workload resources?"
...
benchmark "well_architected_framework_rel06_bp01" {
  title       = "Reliability: Monitor all components for the workload"
...
benchmark "well_architected_framework_rel06_bp02" {
  title       = "Reliability: Define and calculate metrics (Aggregation)"
